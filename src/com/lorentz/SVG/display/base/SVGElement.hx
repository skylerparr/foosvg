...
class SVGElement extends Sprite implements ICloneable
{
    ...
    private function getViewPortRect() : Rectangle
    {
        ...
        {
            var x : Float = (viewPort.svgX) ? getViewPortUserUnit(viewPort.svgX, SVGUtil.WIDTH) : 0;
            var y : Float = (viewPort.svgY) ? getViewPortUserUnit(viewPort.svgY, SVGUtil.HEIGHT) : 0;
