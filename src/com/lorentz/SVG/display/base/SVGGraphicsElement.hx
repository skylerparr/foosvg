...
class SVGGraphicsElement extends SVGElement
{
    ...
    private function configureDashedDrawer(dashedDrawer : DashedDrawer) : Void
    {
        ...
        dashedDrawer.dashOffset = finalStyle.getPropertyValue("stroke-dashoffset") || 0;
        
        var dashAlign : String = Std.string(finalStyle.getPropertyValue("stroke-dashalign") || "none").toLowerCase();
    ...
    private function beginFill(g : Graphics = null, callBack : Function = null) : Void
    {
        if (hasFill)
        {
            ...
            var fillOpacity : Float = finalStyle.getPropertyValue("fill-opacity") || 1;
    ...
    private function lineStyle(g : Graphics) : Void
    {
        if (hasStroke)
        {
            var strokeOpacity : Float = finalStyle.getPropertyValue("stroke-opacity") || 1;
            ...
            var strokeMiterlimit : Float = finalStyle.getPropertyValue("stroke-miterlimit") || 4;
