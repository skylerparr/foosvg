...
class TextUtils
{
    public static inline var SUPERSCRIPT_OFFSET : Float = 0.33;
    public static inline var SUBSCRIPT_OFFSET : Float = 0.2;
    
    public static function getParagraphDirection(text : String) : String
    {
        var i : Int = as3hx.Compat.parseInt(text.length - 1);
        while (i >= 0)
        {
    ...
    {
        var bidiCharacterTypes : Array<Dynamic> = [
        {
            type : "L",
            ranges : LRanges
        }, 
        ...
        for (characterType in bidiCharacterTypes)
        {
            for (range/* AS3HX WARNING could not determine type for var: range exp: EField(EIdent(characterType),ranges) type: null */ in characterType.ranges)
            {
                ...
                else if (code >= range[0] && code <= range[1])
                {
                    return characterType.type;
                }
            }
    ...
    private static var LRanges : Array<Dynamic> = [
        [0x0041, 0x005A], 
        [0x0061, 0x007A], 
        [0x00AA], 
        [0x00B5], 
    ...
    private static var RRanges : Array<Dynamic> = [
        [0x0590], 
        [0x05BE], 
        [0x05C0], 
        [0x05C3], 
    ...
    private static var ALRanges : Array<Dynamic> = [
        [0x0604, 0x0605], 
        [0x0608], 
        [0x060B], 
        [0x060D], 
