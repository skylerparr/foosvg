...
@:final class Bezier {
    /**
		 ...
		 */
    public static var tolerance: Float = 1;

    public static var savedBeziers: Dynamic = {};

    public var p1: Point = null;
    public var p2: Point = null;
    public var c1: Point = null;
    public var c2: Point = null;
    public var QPts: Array<Dynamic> = null;
    ...
    c2 - second control
    */
    public function new(p1Anchor: Point, c1Control: Point, c2Control: Point, p2Anchor: Point) {
        p1 = p1Anchor;
        p2 = p2Anchor;
        c1 = c1Control;
        c2 = c2Control;
        QPts = new Array<Dynamic>();
    ...
    */
    private function GetQuadBez_RP(a: Point, b: Point, c: Point, d: Point): Void {
        ...
        var halves: Dynamic = MathUtils.bezierSplit(a, b, c, d);
        var b0: Dynamic = halves.b0;
        var b1: Dynamic = halves.b1;
